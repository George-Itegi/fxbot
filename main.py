...
class DerivBot:
    ...
    async def start(self):
        ...
        logger.info(f"  Model:      {self.model_type} (ML SOFT PENALTY — 10% reduction on disagreement, no blocking)")
        ...
        logger.info("    - ML SOFT PENALTY: ML disagreement now reduces confidence by 10%")
