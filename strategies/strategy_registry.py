...
REGISTRY = {
    ...
    "FVG_REVERSION": {
        ...
        "promoted_to_live":  None,
        "notes":       "SMC Structure — enters at unfilled Fair Value Gap midline when price retraces, 60-70% gap fill rate",
    },
    "EMA_CROSS_MOMENTUM": {
    ...
    "BREAKOUT_MOMENTUM": {
        ...
        "promoted_to_paper": "2026-04-24",
        "promoted_to_live":  None,
        "notes":       "SMC_STRUCTURE — expansion-based breakout from consolidation with retest entry. Complements reversion-based SMC strategies.",
    },
    "STRUCTURE_ALIGNMENT": {
        ...
        "promoted_to_paper": "2026-04-24",
        "promoted_to_live":  None,
        "notes":       "ORDER_FLOW — BOS + H1 structure + delta agreement (not divergence). Second ORDER_FLOW strategy.",
    },
